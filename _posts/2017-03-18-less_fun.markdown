...
might be an artifact of optimizer choices in this particular case,
and won't be noticed in a larger application. Thus, let's just assume
both versions perform equally well.
